...
public class DTParameters<T>
{
    ...
    public int? selectid2 { get; set; }
    public string selectStr2 { get; set; }
    public string selectStr3 { get; set; }
    public int? param1 { get; set; }
    public string pagingSearchParam { get; set; }
    /// <summary>
    /// Draw counter.
    ...
    /// </summary>
    public DTColumn<T>[] Columns { get; set; }
    ...
    /// </summary>
    public DTSearch<T> Search { get; set; }
    ...
    public DTOrder DTOrder { get; set; }
